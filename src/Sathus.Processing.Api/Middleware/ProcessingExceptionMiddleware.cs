...
namespace Sathus.Processing.Api.Middleware;

public sealed class ProcessingExceptionMiddleware
{
    private readonly RequestDelegate _next;
    private readonly ILogger<ProcessingExceptionMiddleware> _logger;

    public ProcessingExceptionMiddleware(RequestDelegate next, ILogger<ProcessingExceptionMiddleware> logger)
    {
        _next = next;
        _logger = logger;
    }
    ...
    private async Task HandleAsync(HttpContext context, Exception exception)
    {
        ...
        var problem = exception switch
        {
            ...
            ProcessingJobNotFoundException or InvalidProcessingStateException or UnsupportedAssetException or AssetProcessingException =>
