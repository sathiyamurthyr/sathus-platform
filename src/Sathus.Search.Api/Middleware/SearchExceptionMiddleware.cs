...
namespace Sathus.Search.Api.Middleware;

/// <summary>
/// Maps exceptions to RFC 7807 ProblemDetails responses.
/// </summary>
public sealed class SearchExceptionMiddleware
{
    private readonly RequestDelegate _next;
    private readonly ILogger<SearchExceptionMiddleware> _logger;

    public SearchExceptionMiddleware(RequestDelegate next, ILogger<SearchExceptionMiddleware> logger)
    {
        _next = next;
        _logger = logger;
    }
    ...
    private async Task HandleAsync(HttpContext context, Exception exception)
    {
        ...
        var problem = exception switch
        {
            ...
            SearchIndexNotFoundException or SearchDocumentNotFoundException =>
                Build((int)HttpStatusCode.NotFound, "Not Found", exception.Message),
            SearchProviderNotSupportedException or SearchInvalidQueryException or SearchIndexingException =>
