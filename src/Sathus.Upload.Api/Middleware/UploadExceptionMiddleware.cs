...
namespace Sathus.Upload.Api.Middleware;

public sealed class UploadExceptionMiddleware
{
    ...
    private async Task HandleAsync(HttpContext context, Exception exception)
    {
        ...
        var problem = exception switch
        {
            ...
            UploadSessionNotFoundException or InvalidUploadStateException or ChunkValidationException or DuplicateUploadException or UploadQuotaExceededException =>
