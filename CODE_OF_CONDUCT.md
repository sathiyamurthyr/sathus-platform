...
**conduct@sathus.example** (replace with the project's real address). All
...
1. **Correction** — A private, written warning for a first offense.
2. **Warning** — A warning with consequences for continued behavior.
3. **Temporary Ban** — A temporary ban from interaction in community spaces.
