            ...
            <div className="w-full lg:w-auto">
              ...
              >
                <input
                  ...
                  className="flex-1 lg:w-64 h-9 px-3 rounded-md border bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
