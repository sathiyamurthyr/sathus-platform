...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: Array<{ route: string; priority: number; changeFreq: 'daily' | 'weekly' | 'monthly' }> = [
    ...
    { route: '/resources/documentation', priority: 0.8, changeFreq: 'weekly' },
    { route: '/resources/faqs', priority: 0.8, changeFreq: 'monthly' },
    ...
    { route: '/company/why-sathus', priority: 0.7, changeFreq: 'monthly' },
    { route: '/company/partners', priority: 0.7, changeFreq: 'monthly' },
